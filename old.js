...
const routeSelect = document.querySelector('.filter__select--route')
...
const apiEstimateTimeGet = () => apiBusRequest.get(`/EstimatedTimeOfArrival/City/Kaohsiung/${filterObj['filterRouteName']}?$format=JSON`)

const apiStopRouteGet = () => apiBusRequest.get(`/StopOfRoute/City/Kaohsiung/${filterObj['filterRouteName']}?$format=JSON`)
...
function filterCitySelect(e) {
  filterObj['filterRoute'] = e.target.value
